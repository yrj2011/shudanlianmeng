...
rs.open "Select * From "&jieducm&"_register where username='" &session("useridname")& "' and czm='"&code&"'" ,Conn,1,1  
IF Rs.Eof Then
...
<DIV>
<P>操作码：</P><INPUT id=code type=password maxLength=16 name=code><SPAN 
id=ctl00_AllBaseContentPlaceHolder_RequiredFieldValidator1 
style="DISPLAY: none; COLOR: red">* 操作码不能为空！</SPAN></DIV><BR>
<DIV><INPUT id=button1  type=submit value="  提交  " name=button1></DIV><BR><BR></DIV></DIV>
