...
<head>
<title>第8步 -发布任务教程_<%=stupname%></title>
...
<table width="960" border="5" align="center" cellpadding="0" cellspacing="0" bordercolor="#6633FF" class="Colorlans">
  <tr>
    <td valign="top" align="left" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="51"><div align="center"><img src="jc/8.gif" alt="发布任务帮助" width="900" height="400" border="0" usemap="#Map" />
            <map name="Map" id="Map">
              <area shape="rect" coords="735,204,825,237" href="jc09.asp" />
            </map>
        </div></td>
      </tr>
	   <tr>
        <td height="51"><div align="center"><a href="/jc07.asp"><img src="images/teach/Syb.gif" width="115" height="30"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/jc09.asp"><img src="images/teach/xyb.gif" width="115" height="30"></a></div></td>
      </tr>
    </table></td>
  </tr>
</table>
