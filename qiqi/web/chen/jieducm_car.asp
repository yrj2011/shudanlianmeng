...
<table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center>
  <tr>
	<td colspan="2" align="center" class="title"><strong>网站点卡管理</strong></td>
  </tr>
  <tr class="tdbg"> 
    <td width="70" height="30" ><strong>管理导航：</strong></td>
    <td><a href="jieducm_caradd.asp">添加点卡</a></td>
  </tr>
</table>
<table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center><tr></tr>
</table>
<table width='100%' border="0" cellpadding="0" cellspacing="0" ><tr>
    <form name="myform" method="Post" action="jieducm_cardel.asp" onSubmit="return ConfirmDel();">
      <table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center>
        <tr>
     ...
     <td><table class="border" border="0" cellspacing="1" width="100%" cellpadding="0">
          <tr class="title" height="22"> 
            ...
            <td width="163" align="center" ><strong>点卡名称</strong></td>
            <td width="163" align="center" ><strong>点卡价格</strong></td>
            <td width="113" align="center" ><strong>点卡送发布点</strong></td>
            <td width="139" align="center" ><strong>点卡介绍</strong></td>
			...
			<%	
   	sql="SELECT * FROM "&jieducm&"_car  order by id desc"
	...
	if PageNo=1 then i=rs.RECORDCOUNT else i=rs.RECORDCOUNT-(30*(PageNo-1))
	  DO WHILE NOT rs.EOF AND RowCount>0%>
		  <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#cccccc'" style="padding: 0px 2px;">
            ...
            <td width="163" align="center"><%=rs("car_price")%></td>
            <td width="113" align="center"><%=rs("car_fabudian")%></td>        
            <td width="139" align="center"><%=rs("car_content")%></td>
            <td width="161" align="center"><%=rs("now")%></td>
            <td width="161" align="center"><a href="jieducm_carmodify.asp?id=<%=rs("id")%>">修改</a>&nbsp; <a href="jieducm_cardel.asp?id=<%=rs("id")%>" onClick="return confirm('确定要删除此点卡吗？');" >删除</a></td>
