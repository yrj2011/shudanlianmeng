...
<%
if trim(request("UserType"))="User" then
%>
<iframe class="HtmlEdit" ID="HtmlEdit" src="User_ArticleContent.asp?Action=<%=trim(request("Action"))%>&ArticleID=<%=trim(request("ArticleID"))%>" MARGINHEIGHT="1" MARGINWIDTH="1" style="width=100%; height=266;"> </iframe>
<%else%>
<iframe class="HtmlEdit" ID="HtmlEdit" src="Admin_ArticleContent.asp?Action=<%=trim(request("Action"))%>&ArticleID=<%=trim(request("ArticleID"))%>" MARGINHEIGHT="1" MARGINWIDTH="1" style="width=100%; height=266;"> </iframe>
<%end if%>
