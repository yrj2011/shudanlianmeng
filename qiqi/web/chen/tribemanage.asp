...
function ConfirmDel()
{
	...
	{
		document.myform.action="tribe_del.asp";
		if(confirm("确定要删除选中的记录吗？本操作将把无法恢复！删除后的部落中的会员将自动退出部落！"))
		    return true;
		else
			return false;
	}
	...
	{
		document.myform.action="heidel.asp";
...
<table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center>
  <tr>
	<td colspan="2" align="center" class="title"><strong>部落管理</strong></td>
  </tr>
  <tr class="tdbg"> 
    <td width="70" height="30" ><strong>管理导航：</strong></td>
    <td><a href="tribe_add.asp">添加部落  </a> <a  href="tribemanage.asp">部落管理</a></td>
  </tr>
</table>
<table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center><tr></tr>
</table>
<table width='100%' border="0" cellpadding="0" cellspacing="0" ><tr>
    <form name="myform" method="Post" action="tribe_del.asp" onSubmit="return ConfirmDel();">
      <table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center>
        <tr>
     ...
     <td><table class="border" border="0" cellspacing="1" width="100%" cellpadding="0">
          <tr class="title" height="22"> 
            ...
            <td width="151" align="center"><strong>部落名称</strong></td>
            <td width="151" align="center"><strong>建立时间</strong></td>
            <td width="151" align="center"><strong>激活码</strong></td>
            <td width="151" align="center"  height="22"><strong>酋长</strong></td>
            <td width="161" align="center" ><strong>会员人数</strong></td>
            <td width="161" align="center" ><strong>操作</strong></td>
            <!--<td width="40" align="center" ><strong>已审核</strong></td>-->
          </tr>
       
			<%	
   	sql="SELECT * FROM  "&jieducm&"_tribe  order by id desc"
	...
	if PageNo=1 then i=rs.RECORDCOUNT else i=rs.RECORDCOUNT-(30*(PageNo-1))
	 DO WHILE NOT rs.EOF AND RowCount>0%>
		  <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#cccccc'" style="padding: 0px 2px;">
            ...
            <td width="151" align="center"><%=rs("tribename")%></td>
            <td width="151" align="center"><%=rs("now")%></td>
            <td width="151" align="center"><%=rs("triberad")%></td>
            <td width="151" align="center"><%=rs("username")%></td>
            <td width="161" align="center">
			<% Sql1 = "select  count(*) as renwu  from "&jieducm&"_register where tribeid="&rs("id")&" "
		    ...
		    rs1.close
			  %></td>
            <td width="161" align="center"><a href="tribe_modify.asp?id=<%=rs("id")%>">修改</a>&nbsp; <a href="tribe_del.asp?id=<%=rs("id")%>" onClick="return confirm('确定要删除选中的记录吗？本操作将把无法恢复！删除后的部落中的会员将自动退出部落！');">删除</a></td>
