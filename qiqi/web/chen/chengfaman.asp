    ...
    <form name="myform" method="Post" action="chengfadel.asp" onSubmit="return ConfirmDel();">
     ...
     <td><table class="border" border="0" cellspacing="1" width="100%" cellpadding="0">
          <tr class="title" height="22">
            <td width="156" align="center" ><strong>流水号</strong></td> 
            <td width="156" height="22" align="center" ><strong>用户名</strong></td>
            <td width="126" align="center" ><strong>惩罚类别</strong></td>
            <td width="123" align="center" ><strong>惩罚金额</strong></td>
            <td width="164" align="center" ><strong>操作人</strong></td>
            <td width="164" align="center" ><strong>惩罚时间</strong></td>
            <td width="323" align="center" ><strong>操作</strong></td>
	...
	if PageNo=1 then i=rs.RECORDCOUNT else i=rs.RECORDCOUNT-(30*(PageNo-1))
	 DO WHILE NOT rs.EOF AND RowCount>0%>
		  <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#cccccc'" style="padding: 0px 2px;">
            ...
            <td width="126" align="center"> <%if rs("leibie")=1 then%>奖励<%else%>处罚<%end if%></td>
...
classname="个积分" 
			...
			'else
				'response.write "否"
			'end if%></td>-->
            <td width="323" align="center"><a href="chengfadel.asp?id=<%=rs("id")%>">删除</a><br></td>   
          </tr>
            <%
      rs.MoveNext
	  RowCount = RowCount - 1 
