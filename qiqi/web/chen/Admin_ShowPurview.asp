...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border">
  <tr> 
    <td height="22" colspan="2" align="center" class="title"><strong>查 看 管 理 权 限</strong></td>
  </tr>
  <tr class="tdbg"> 
    <td width="70" height="30"><strong>管理导航：</strong></td>
    <td height="30"><a href="Admin_ShowPurview.asp">所有管理权限</a> | <a href="Admin_ShowPurview.asp?ChannelID=2">文章频道权限</a> | <a href="Admin_ShowPurview.asp?ChannelID=3">软件频道权限</a> | <a href="Admin_ShowPurview.asp?ChannelID=4">图片频道权限</a></td>
  </tr>
</table>
<%
response.write "<br>您现在的位置：查看管理权限&nbsp;&gt;&gt;&nbsp;<font color='#ff6600'>"
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border">
  <tr> 
    <td colspan="2" class="title"><strong>文 章 频 道</strong> 
      <%
  ...
  <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#cccccc'" style="padding: 0px 2px;"> 
    ...
    <td align="center" width="20%"> 
      <%if AdminPurview_Article<=2 then
			response.write "<font color='#0066cc'>全部权限</font>"
		elseif AdminPurview_Article=3 then
			response.write "<a href='Admin_ShowPurview.asp?ChannelID=2'><font color='#0066cc'>部分权限</font></a>"
		else
			response.write "<font color='#ff6600'>无权限</font>"
		end if
	  %>
    </td>
    ...
    <td align="center" width="20%"> 
      <%if AdminPurview_Soft<=2 then
		...
		elseif AdminPurview_Soft=3 then
			response.write "<a href='Admin_ShowPurview.asp?ChannelID=3'><font color='#0066cc'>部分权限</font></a>"
		else
			response.write "<font color='#ff6600'>无权限</font>"
		end if
	  %>
    ...
    <td align="center" width="20%"> 
      <%if AdminPurview_Photo<=2 then
		...
		elseif AdminPurview_Photo=3 then
			response.write "<a href='Admin_ShowPurview.asp?ChannelID=4'><font color='#0066cc'>部分权限</font></a>"
		else
			response.write "<font color='#ff6600'>无权限</font>"
		end if
	  %>
    ...
    <td align="center" width="20%"> 
      <%if AdminPurview_Channel<=2 then
		...
		elseif AdminPurview_Channel=3 then
			response.write "<font color='#0066cc'>部分权限</font>"
		else
			response.write "<font color='#ff6600'>无权限</font>"
		end if
	  %>
