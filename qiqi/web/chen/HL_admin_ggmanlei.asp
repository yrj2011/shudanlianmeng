...
alert("信息删除成功!");
location.href("HL_admin_ggmanlei.asp");
</script>
<%
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
    <tr>
      <td colspan="3" bgcolor="#A6B5F0"><table cellpadding="2" cellspacing="1" border="0" width="100%" align="center" class="a2">
		...
		rs1.open "select * from "&jieducm&"_ggwei where hl_lei=1  order by hl_ID Desc",conn,1,1
		...
		%>
		 ...
		 %>
          <tr>
            ...
            <td width="46%" background="images/titlebg.gif" bgcolor="#CED7F7" class="a1"><div align="center"><a href="hl_admin_ggmanlei.asp?action=yes&id=<%=rs1("hl_id")%>">删除</a></div></td>
          </tr>
           <%
		 rs1.movenext
		 loop
