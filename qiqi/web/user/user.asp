      ...
      <td height="5"></td>
                ...
                <div class=pp9>
                  <div style="PADDING-BOTTOM: 15px; WIDTH: 97%">
                    <div class=pp7>您现在的位置是：<%=stupname%> &gt;&gt; 会员中心 &gt;&gt; 站内信 &gt;&gt; </div>
                    <div class=pp8><strong>站内信</strong></div>
...
if keyword <>"" then
sql="select * from "&jieducm&"_china_message where ( uid='all') and zn='yes' and ( messagename like '%" & keyword & "%' or  messagelxfs like '%" & keyword & "%' or messagetext like '%" & keyword & "%' ) order by id desc"
else
sql="select * from "&jieducm&"_china_message where (uid='all') and zn='yes' order by id desc"
end if
			...
			form.submit();
				...
				<br>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td colspan="8"><ul class="private-msg-tab">
                              <li class="selected"><a href="#">站内信</a></li>
                            <li><a href="users.asp ">私人站内信</a></li>
                          </ul></td>
                        </tr>
                        <tr>
                          <th scope="col" width="1%"align="center">&nbsp;</th>
                          <th scope="col" width="17%"align="center"><div align="left">编号</div></th>
                          <th scope="col" width="11%" align="center"><div align="left">发送人</div></th>
                          <th scope="col" width="34%" align="center"><div align="left">标题</div></th>
...
%>
                        <tr>
                          ...
                          <td><a href="zn_messagelook.asp?id=<%=rs("id")%>" >
                            <% if rs("hits")=0 then%>
                            <font color="#000000" size="3 px;">
                              <%else%>
                            <font color="#0066CC">
                              <%end if%>
                              <strong><%=rs("messagelxfs")%></strong></font></font></a> </td>
    ...
    loop    
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="CAE2F8">
                      <tr>
                        <td height="28" bgcolor="#FFFFFF"><p align="center">页数：<%=currentpage%>/<%=n%>
                                <%k=currentpage                                                                                         
   	if k<>1 then%>
                        ...
                        <form action="" method="post" name="search">
                          <td width="240" align="center" bgcolor="#FFFFFF">关键字
