...
param ='&'+	param;	   
   ...
   $.post('/chongzhi/jieducm-ajax.asp?open=myajex',function (data) {
$('#content').html(data);
   $('#waitingimage').hide();
    ...
    <div style="CLEAR: both; MARGIN-TOP: 2px; WIDTH: 910px; HEIGHT: 25px">
      <div style="FLOAT: left; OVERFLOW: hidden; WIDTH: 700px">
        <ul id=task_nav>
          ...
          <li><a style="FONT-SIZE: 16px; BACKGROUND: url(../images/task_nav_02.gif) no-repeat 50% bottom; COLOR: #ffffff" href="javascript:void(0)" onClick="reloadTask()">已发提现</a> </li>
...
<DIV style="FONT-WEIGHT: bold; FONT-SIZE: 14px; FLOAT: left; WIDTH: 115px; COLOR: #006600; TEXT-ALIGN: center">提现金额</DIV>
...
if action="" then
Sql = "select * from "&jieducm&"_zhongxin where classid='5'  and username='"&session("useridname")&"'  order by start  asc ,id desc"
elseif action="6" then
Sql = "select * from "&jieducm&"_zhongxin where classid='5'  and username='"&session("useridname")&"'  order by start  asc ,now desc"
else
Sql = "select * from "&jieducm&"_zhongxin where classid='5'  and username='"&session("useridname")&"' and start='"&action&"' order by start  asc ,id desc"
end if
...
<img src="../images/j_z.gif" width="13" height="16"><%=Price%>元<br>
</font>
</DIV>
...
[申诉]</font></a><a href="../user/name.asp?heiname=<%=username%>" target="_blank"><font color="#FF0000">
[拉黑]</font></a>
...
<DIV style="WIDTH: 98%; LINE-HEIGHT: 20px; PADDING-TOP: 2px;  TEXT-ALIGN: center">  <div align="left">
<font color="#FF0000"> 禁用旺旺联系 </font></div>
<%if rs("tips")<>"" then%> <br>
 <div align="left">  
 卖家提示：<font color="#FF0000"><%=rs("tips")%></font>
 </div>
 <%end if%> 
  </DIV>
</DIV>
