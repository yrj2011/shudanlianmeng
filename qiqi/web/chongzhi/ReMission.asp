...
param ='&'+	param;	   
   ...
   $.post('/chongzhi/jieducm-ajax.asp?open=Reajex',function (data) {
$('#content').html(data);
   $('#waitingimage').hide();
...
<UL id=task_nav>
  ...
  <LI><A style="FONT-SIZE: 16px; BACKGROUND: url(../images/task_nav_02.gif) no-repeat 50% bottom; COLOR: #ffffff" href="javascript:void(0)" onClick="reloadTask()">已接充值</A> </LI>
...
<DIV style="MARGIN-TOP: 12px; FLOAT: left; MARGIN-LEFT: 10px"><A href="?sort=0"><SPAN class=anniu>我接手进行中任务</SPAN></A>
...
<DIV style="FONT-WEIGHT: bold; FONT-SIZE: 14px; FLOAT: left; WIDTH: 115px; COLOR: #006600; TEXT-ALIGN: center">充值金额</DIV>
...
if action="" then
Sql = "select * from "&jieducm&"_jieshou where classid='5'  and username='"&session("useridname")&"'  order by start asc ,id desc"
elseif action="6" then
Sql = "select * from "&jieducm&"_jieshou where classid='5'  and username='"&session("useridname")&"'  order by start  asc"
else
Sql = "select * from "&jieducm&"_jieshou where classid='5'  and username='"&session("useridname")&"' and start='"&action&"' order by start asc,id desc"
end if
...
[<a href="../user/name.asp?heiname=<%=usernamef%>" target="_blank"><font color="#FF0000">拉黑</font></a>]
<br />
[<a href="../user/sms.asp?fausername=<%=usernamef%>" target="_blank"><font color="#FF0000">发手机短信</font></a>]
</DIV>
</DIV>
<DIV style="FLOAT: left; WIDTH: 115px;  TEXT-ALIGN: center"><font color=#ff6600><br>
  <img src="../images/j_z.gif" width="13" height="16"><%=rs("Price")%>元</font><br>
</DIV>
...
<%end if%></DIV>
</DIV><DIV style="WIDTH: 98%; LINE-HEIGHT: 20px; PADDING-TOP: 10px;  TEXT-ALIGN: center">  
<div align="left">
 <font color="#FF0000"> 禁用旺旺联系 
 </font>
 <%if tips<>"" then%> <br>
 <div align="left">  
