...
Sql = "select count(*) as yu  from   "&jieducm&"_keeper where username='"&session("useridname")&"' and class=2"
	  ...
	  if rs.eof then
    	...
    	rs.close
		 Response.Write("<script>alert('绑定成功!');window.location.href='myww.asp';</script>")
	 	 ...
	 	 Response.Write("<script>alert('此拍拍店铺掌柜帐号已被其它用户绑定!');history.back();</script>")
	 end if
end if
%>	
...
<UL id=paipai_task_nav>
  ...
  <LI><A href="MyMission.asp">已发任务</A> </LI>
    <LI><A style="FONT-SIZE: 16px; BACKGROUND: url(../images/paipai_task_nav_02.gif) no-repeat 50% bottom; COLOR: #ffffff" href="MyWw.asp">绑定店铺</A> </LI>
...
<DIV 
style="BACKGROUND: url(../images/task_bg_01.jpg) repeat-x 50% top; WIDTH: 910px; LINE-HEIGHT: 38px; HEIGHT: 38px; TEXT-ALIGN: center">我已绑定的拍拍店铺帐号，绑定店铺掌柜号后才能发任务。 
</DIV></DIV>
...
align=center>
  <TBODY>
  <TR>
    <TD align=right height=30>拍拍店铺掌柜QQ号：</TD>
    <TD><div align="left">
      ...
      <TABLE cellSpacing=0 cellPadding=0 align=left border=0>
        ...
        <TR>
          ...
          <TD align=middle width=180 
            ...
            color=#ffffff>已绑定拍拍店铺帐号</FONT></TD>
...
<table width="69%" align="center" cellpadding="5" cellspacing="1" bgcolor="#D0DBE3" >
        <tr bgcolor="#E1F2FB">
          <td height="29" class="yell_font" style="FONT-WEIGHT: bolder; WIDTH: 15%"><div align="center">拍拍店铺掌柜 </div></td>
          <td class="yell_font" style="FONT-WEIGHT: bolder; WIDTH: 20%"><div align="center">绑定时间 </div></td>
        </tr>
        <tbody>
		  <%
			  	Sql = "select * from "&jieducm&"_keeper  where username='"&session("useridname")&"' and class=2 order by id desc "
				Set Rs = Server.CreateObject("Adodb.RecordSet")
