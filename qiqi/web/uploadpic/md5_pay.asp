...
<tr>
 ...
 <DIV class=pp9>
      ...
      <UL>
        ...
        <LI>* 平台给您提供了以下三种简单的充值方式，通过任意一种方式均可以实现“充值到平台”！ </LI>
      </UL></DIV>
	  <%if stupcar=1 then%>
...
<font color="#FF0000">3、将交易号和充值金额输入到下面的&ldquo;支付宝支付信息&rdquo;下框中并提交，系统会在1分钟左右自动充值完成。</font></p>
                <p style="color:#F63; font-size:16px; font-weight:bold;">收款支付宝唯一账户：<span id="AlipayAccount"><%=stupzfb%></span>&nbsp; 姓名：谢善慧</p>
      ...
      <DIV class=pp8 style="color:blue; font-weight:bold">填写支付宝支付信息</DIV>
      <TABLE width="100%" border=0 cellPadding=0 cellSpacing=0>
        ...
        <TR>
          <td align=left><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  2、在财付通网站页面中完成支付，再到财付通网站顶部的“交易查询”，找到刚收支明细详情的“交易单号”，复制交易号的数字，类似“1000000000201309210268769XXXX”发给充值客服
			  </p>
                <p style="color:#F63; font-size:16px; font-weight:bold;">收款财付通唯一账户：<span id="AlipayAccount"><%=stupcft%></span>&nbsp; 姓名：谢善慧</p>
                <table width="100%" border="0">
                <tr>
                  <td align="right">&nbsp;</td>
                  <td align="left"><input type="hidden" name="UserName" id="UserName" value="<%=session("useridname")%>" readonly="readonly" /></td>
                ...
                <tr>
                  <td align="right">&nbsp;</td>
                  <td align="left" height=30> <A href="http://www.tenpay.com/" 
      target=_blank><input type="button" value=" 确定充值 "  /></A></td>
                </tr>
              </table>
              <br /></td>
            </tr>
...
>
  ...
  &nbsp;&nbsp; <font color="#FF0000">*</font>必填项，譬如：<font color="#FF0000">100.00</font><br>
		...
		<%end if%>
		<%if stupyibao=1 then%>
		 <DIV class=pp8><STRONG>易宝在线充值：</STRONG>立即自动到账</DIV>
      <DIV style="MARGIN-TOP: 10px; LINE-HEIGHT: 200%">
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
