...
<%
'****************************************	
	v_mid = stupwu					                 ' 商户号，这里为测试商户号1001，替换为自己的商户号(老版商户号为4位或5位,新版为8位)即可21044436
	
	v_url = ""&stupurl&"/chinabank/jieducm_Receive.asp" ' 商户自定义返回接收支付结果的页面 Receive.asp 为接收页面
									
	key = stupshi									 ' 07718140226如果您还没有设置MD5密钥请登陆我们为您提供商户后台，地址：https://merchant3.chinabank.com.cn/
