...
sql="SELECT  count(*) as totalj FROM "&jieducm&"_jieshou where classid='1' and username='"&session("useridname")&"' and start<>'5'"
Set Rs = Server.CreateObject("Adodb.RecordSet")
...
sql="SELECT  count(*) as totalnum FROM  "&jieducm&"_jieshou where username='"&session("useridname")&"' and  num='"&num&"' and proUrl='"&ProUrlj&"' and  (datediff(month,[now],getdate())=0) and classid='1'"
Set rs = Server.CreateObject("Adodb.RecordSet")
rs.Open Sql,conn,1,1
if not rs.eof then	
jh=rs("totalnum")
...
sql="SELECT  count(*) as monthnum FROM  "&jieducm&"_jieshou where Shopkeeper='"&Shopkeeper&"' and username='"&session("useridname")&"' and  num='"&num&"' and classid='1' and  (datediff(month,[now],getdate())=0) "
Set rs = Server.CreateObject("Adodb.RecordSet")
rs.Open Sql,conn,1,1
if not rs.eof then	
...
sql="SELECT  count(*) as monthip FROM  "&jieducm&"_jieshou where Shopkeeper='"&Shopkeeper&"' and username='"&session("useridname")&"' and  ip='"&ip&"' and classid='1' and  (datediff(month,[now],getdate())=0) "
Set rs = Server.CreateObject("Adodb.RecordSet")
rs.Open Sql,conn,1,1
if not rs.eof then	
...
sql="SELECT  count(*) as datanum FROM  "&jieducm&"_jieshou where shopkeeper='"&Shopkeeper&"' and username='"&session("useridname")&"'  and num='"&num&"' and classid='1' and  ( datediff(day,[now],getdate())=0)"
Set rs = Server.CreateObject("Adodb.RecordSet")
rs.Open Sql,conn,1,1
if not rs.eof then	
...
sql="SELECT  count(*) as jieducm_aobaonum FROM  "&jieducm&"_jieshou where  num='"&num&"' and classid='1' and  ( datediff(day,[now],getdate())=0)"
Set rs = Server.CreateObject("Adodb.RecordSet")
rs.Open Sql,conn,1,1
if not rs.eof then	
...
sql="SELECT  count(*) as dataip FROM  "&jieducm&"_jieshou where Shopkeeper='"&Shopkeeper&"' and username='"&session("useridname")&"' and  ip='"&ip&"' and classid='1' and  (datediff(day,[now],getdate())=0) "
Set rs = Server.CreateObject("Adodb.RecordSet")
rs.Open Sql,conn,1,1
if not rs.eof then	
