...
conn.execute sqlr
    	...
    	rs("num")=num
		rs("class")="淘宝区任务"
		rs("content")=session("useridname")&"确认接手人"&jusername&"的好评-任务ID:"&id&"确认已好评对方收到了你的"&price&"元担保金和"&fabu1&"个发布点,你也得到"&stupfajifei&"个积分"
		rs("price")=0
		rs("jiegou")="确认已好评任务完成!"
    	rs.update
    	rs.close
    	...
    	rs("num")=num
		rs("class")="淘宝区任务"
		rs("content")=session("useridname")&"确认你的好评-任务ID:"&id&"确认已好评你已收到了对方的"&price&"元担保金和"&fabu1&"个发布点，得到"&stupfajifei&"个积分"
		rs("price")="+"&price
		rs("jiegou")="确认已好评任务完成!"
    	rs.update
    	rs.close
