...
rs.open "select * from "&jieducm&"_zhongxin where pid='"&id&"' and username='"&session("useridname")&"' and start='1'",conn,1,1
if rs.eof then
    Response.Write("<script>alert('对不起,操作有误无此信息!');window.location.href='MyMission.asp';</script>")
	response.End()
end if 
