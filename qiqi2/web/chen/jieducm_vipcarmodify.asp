...
if action="modify" then	  
	 Sql= "select * from "&jieducm&"_vipcar where id="&request("car_id")&""
	 ...
	 if not rs.eof then
	   ...
	   Response.Write("<script>alert('对不起！无此点卡!');history.back();</script>")
	   response.End()
	 end if
	 Response.Write("<script>alert('修改成功!');window.location.href='jieducm_vipcar.asp';</script>")
	 response.End()
end if
%>
<html>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border">
  <tr> 
    <td height="22" colspan="2" align="center" class="title"><strong>VIP卡管理</strong></td>
  </tr>
  <tr class="tdbg"> 
    <td width="70" height="30"><strong>管理导航：</strong></td>
    <td height="30"><a href="jieducm_vipcaradd.asp">添加VIP卡  </a> <a  href="jieducm_vipcar.asp">VIP卡管理</a></td>
  </tr>
</table>
...
<tr class="tdbg">
    ...
    <tr class="tdbg">
      ...
      <td class="tdbg"><input type="text" name="car_price" onKeyUp="if(isNaN(value))execCommand('undo')" value="<%=rs("car_price")%>"></td>
    </tr>
    <tr class="tdbg">
      <td class="tdbg"><DIV align="right">送发布点数：</DIV></td>
      <td class="tdbg"><label>
        <input type="text" name="car_fabudian" value="<%=rs("car_fabudian")%>">
      </label></td>
    </tr>
    <tr class="tdbg">
      <td class="tdbg"><DIV align="right">VIP卡有效期：</DIV></td>
      <td class="tdbg"><label>
        <input type="text" name="car_date" value="<%=rs("car_date")%>" onKeyUp="if(isNaN(value))execCommand('undo')">天
      </label></td>
    </tr>
    <tr class="tdbg">
    ...
    <tr> 
      <td height="40" colspan="2" align="center" class="tdbg"><input  type="submit" name="Submit" value=" 修&nbsp;&nbsp;改 " style="cursor: hand;background-color: #cccccc;">&nbsp; 
		<input name="Cancel" type="button" id="Cancel" value=" 取&nbsp;&nbsp;消 " onClick="window.location.href='jieducm_car.asp'" style="cursor: hand;background-color: #cccccc;"></td>
    </tr>
<%end if%>
  </form>
</table>
