...
<table border=0 width=100% align=center bgcolor="#FFFFFF">
  <tr>
            <td width="100%"> 
              <div align="center">
                <form name="form1" method="post" action="admin_MyMissionjie4.asp">
...
style="FONT-WEIGHT: bolder; FONT-SIZE: 18px; COLOR: red">已接充值提现区任务</SPAN>&nbsp; 
* <A href="admin_MyMissionjie4.asp">所有任务</A>
* <A href="admin_MyMissionjie4.asp?sort=0">进行中任务</A>*<A href="admin_MyMissionjie4.asp?sort=2">等待支付</A>
*<A href="admin_MyMissionjie4.asp?sort=3">等待发货</A>
*<A href="admin_MyMissionjie4.asp?sort=4">等待接手好评</A>
*<A href="admin_MyMissionjie4.asp?sort=5">等待发方确认</A>
*<A href="admin_MyMissionjie4.asp?sort=6">已经完成</A></DIV>
...
action=request("sort")
if action="" then
			  	Sql = "select * from "&jieducm&"_jieshou where  classid='5'  order by start  asc"
elseif action="0" then 
			  	Sql = "select * from "&jieducm&"_jieshou where  start<>'0' and start<>'5' and  classid='5' order by start  asc"
elseif action="2" then
			  	Sql = "select * from "&jieducm&"_jieshou where start='1'   and  classid='5' order by start  asc"
elseif action="3" then
			  	Sql = "select * from "&jieducm&"_jieshou where  start='2'  and  classid='5' order by start  asc"

elseif action="4" then
			  	Sql = "select * from "&jieducm&"_jieshou where  start='3'   and  classid='5' order by start  asc"
elseif action="5" then
			  	Sql = "select * from "&jieducm&"_jieshou where  start='4'  and  classid='5'  order by start  asc"
elseif action="6" then
			  	Sql = "select * from "&jieducm&"_jieshou where  start='5'  and  classid='5'  order by start  asc"
elseif action="ok" then
 sql="select * from "&jieducm&"_jieshou where  classid='5' and (pid like '%"&request("text")&"%' or  username like '%"&request("text")&"%')   order by id desc"				
end if
...
if not rs.eof then
	...
	if action="" then
	 url="admin_MyMissionjie4.asp"
	elseif action="ok" then
	url="admin_MyMissionjie4.asp?sort=ok&text="&request("text")&""
	else
	 url="admin_MyMissionjie4.asp?sort="&action&""
	end if
	 rs.pagesize=20
