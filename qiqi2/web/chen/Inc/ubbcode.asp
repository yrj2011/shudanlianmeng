...
strContent=re.Replace(strContent,"<a onfocus=this.blur() href=""$1://$2"" target=_blank><IMG SRC=""$1://$2"" border=0 alt=按此在新窗口浏览图片 onload=""javascript:if(screen.width>800){ if(this.width>screen.width-585)this.width=screen.width-585;}else{ if(this.width>screen.width-360)this.width=screen.width-360}""></a>") '此处显示错误由阿炜修正
