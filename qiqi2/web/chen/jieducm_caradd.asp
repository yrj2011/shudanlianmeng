...
if action="add" then	  
	 Sql= "select * from "&jieducm&"_car where car_name='"&request("car_name")&"'"
	 ...
	 Response.Write("<script>alert('添加成功!');window.location.href='jieducm_car.asp';</script>")
	 response.End()
end if
%>
<html>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="border">
  ...
  <tr class="tdbg"> 
    ...
    <td height="30"><a href="jieducm_caradd.asp">添加网站点卡  </a> <a  href="jieducm_car.asp">网站点卡管理</a></td>
  </tr>
</table>
...
<table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center>
 <form action="?action=add" method="POST" name="aspnetForm" id="aspnetForm" onSubmit="return save_onclick()">
    ...
    <tr class="tdbg">
      <td class="tdbg"><DIV align="right">点卡名称：</DIV></td>
      <td class="tdbg"><label>
        <input type="text" name="car_name" >
      </label></td>
    </tr>
    <tr class="tdbg">
      <td class="tdbg"><DIV align="right">点卡价格：</DIV></td>
      <td class="tdbg"><input type="text" name="car_price" onKeyUp="if(isNaN(value))execCommand('undo')" maxlength="5"></td>
    </tr>
    <tr class="tdbg">
      <td class="tdbg"><DIV align="right">点卡送多少发布点：</DIV></td>
      <td class="tdbg"><label>
        <input type="text" name="car_fabudian" onKeyUp="if(isNaN(value))execCommand('undo')" maxlength="5">
      </label></td>
    </tr>
    <tr class="tdbg">
      <td class="tdbg"><DIV align="right">点卡图片：</DIV></td>
      <td class="tdbg"><label>
    ...
    <tr class="tdbg">
      <td width="35%" class="tdbg"><DIV align="right">点卡简介：</DIV></td>
