...
<table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center>
  <tr>
	<td colspan="2" align="center" class="title"><strong>文 章 栏 目 管 理</strong></td>
  </tr>
  <tr class="tdbg"> 
...
<table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center>
  <form name="form1" method="post" action="Admin_Class_Article.asp" onSubmit="return check()">
	<tr>
	  <td colspan="3" align="center" class="title"><strong>添 加 文 章 栏 目</strong></td>
    </tr>
    <tr class="tdbg"> 
    ...
    <tr class="tdbg"> 
      ...
      <td><input name="IsElite" type="radio" value="Yes" checked style="border: 0px;background-color: #eeeeee;">
        是&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="IsElite" value="No" style="border: 0px;background-color: #eeeeee;">
        否 </td>
    </tr>
    <tr class="tdbg"> 
    ...
    <tr class="tdbg"> 
      <td height="40" colspan="2" align="center"><input name="Action" type="hidden" id="Action" value="SaveAdd"> 
        <input name="Add" type="submit" value=" 添&nbsp;&nbsp;加 " style="cursor: hand;background-color: #cccccc;"> 
        &nbsp; <input name="Cancel" type="button" id="Cancel" value=" 取 消 " onClick="window.location.href='Admin_Class_Article.asp'" style="cursor: hand;background-color: #cccccc;"> 
...
<form name="form1" method="post" action="Admin_Class_Article.asp" onSubmit="return check()">
	<tr>
	  <td colspan="3" align="center" class="title"><strong>修 改 文 章 栏 目</strong></td>
    </tr>
    <tr class="tdbg"> 
      <td width="350"><strong>所属栏目：</strong><br>
    ...
    <tr class="tdbg">
      ...
      <td> <input name="IsElite" type="radio" value="Yes" <%if rsClass("IsElite")=True then response.write " checked"%> style="border: 0px;background-color: #eeeeee;">
        是&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="IsElite" value="No" <%if rsClass("IsElite")=False then response.write " checked"%> style="border: 0px;background-color: #eeeeee;">
        否 </td>
    </tr>
    <tr class="tdbg">
      ...
      <td><input name="ShowOnTop" type="radio" value="Yes" <%if rsClass("ShowOnTop")=True then response.write " checked"%> style="border: 0px;background-color: #eeeeee;">
        是&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="ShowOnTop" value="No" <%if rsClass("ShowOnTop")=False then response.write " checked"%> style="border: 0px;background-color: #eeeeee;">
        否 </td>
    </tr>
    <tr class="tdbg">
    ...
    <tr class="tdbg"> 
      <td width="350"><strong>栏目编辑：</strong><br>
        多个编辑请用<span class="style1">“|”</span>分隔，如：流飞|dilys|sws2000<br>
    ...
    <tr class="tdbg"> 
      <td height="40" colspan="2" align="center"><input name="Action" type="hidden" id="Action" value="SaveModify"> 
        <input name="Submit" type="submit" value=" &nbsp;保存修改结果&nbsp; " style="cursor: hand;background-color: #cccccc;"> 
        &nbsp; <input name="Cancel" type="button" id="Cancel" value=" 取&nbsp;&nbsp;消 " onClick="window.location.href='Admin_Class_Article.asp'" style="cursor: hand;background-color: #cccccc;"> 
      </td>
    </tr>
</form>
...
<form name="form1" method="post" action="Admin_Class_Article.asp">
	<tr>
	  <td colspan="3" align="center" class="title"><strong>移 动 文 章 栏 目</strong></td>
    </tr>
    <tr class="tdbg"> 
...
<% 
	if rsClass("ParentID")>0 then   '如果不是一级栏目，则算出相同深度的栏目数目，得到该栏目在相同深度的栏目中所处位置（之上或者之下的栏目数） 
		...
		if UpMoveNum>0 then 
			...
			next 
			response.write "</select>" 
			response.write "<input type=hidden name=ClassID value="&rsClass("ClassID")&">&nbsp;<input type=submit name=Submit value=修&nbsp;改 style='cursor: hand;background-color: #cccccc;'>" 
			response.write "</td></form>" 
		else 
			response.write "<td width='150'>&nbsp;</td>" 
		end if 
...
<table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center>
  <form name="form1" method="post" action="Admin_Class_Article.asp?Action=SaveReset"> 
	<tr>
	  <td colspan="3" align="center" class="title"><strong>复 位 所 有 文 章 栏 目</strong></td> 
  </tr> 
    <tr class="tdbg">  
    <td align="center">  
    ...
    <tr class="tdbg">  
    <td align="center">  
        <input type="submit" name="Submit" value="&nbsp;复位所有栏目&nbsp;" style="cursor: hand;background-color: #cccccc;"> &nbsp;&nbsp;&nbsp; 
		<input name="Cancel" type="button" id="Cancel" value=" 取&nbsp;&nbsp;消 " onClick="window.location.href='Admin_Class_Article.asp'" style="cursor: hand;background-color: #cccccc;">
      </td>
    </tr>
  </form>
...
<form name="myform" method="post" action="Admin_Class_Article.asp" onSubmit="return ConfirmUnite();">
	<tr>
	  <td colspan="3" align="center" class="title"><strong>文 章 栏 目 合 并</strong></td>
  </tr>
  <tr class="tdbg"> 
    <td align="center">
        &nbsp;&nbsp;将栏目 
  ...
  <tr class="tdbg"> 
    <td align="center">
        ...
        <input type="submit" name="Submit" value=" &nbsp;合并栏目&nbsp; " style="cursor: hand;background-color: #cccccc;">
        &nbsp;&nbsp; 
        <input name="Cancel" type="button" id="Cancel" value=" 取&nbsp;&nbsp;消 " onClick="window.location.href='Admin_Class_Article.asp'" style="cursor: hand;background-color: #cccccc;">
