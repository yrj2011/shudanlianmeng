...
function ConfirmDel()
{
	...
	{
		document.myform.action="tribe_bookdel.asp";
...
<table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center>
  <tr>
	<td colspan="2" align="center" class="title"><strong>部落留言管理</strong></td>
  </tr>
  <tr class="tdbg"> 
...
<table width='100%' border="0" cellpadding="0" cellspacing="0" ><tr>
    <form name="myform" method="Post" action="tribe_bookdel.asp" onSubmit="return ConfirmDel();">
      <table cellpadding="0" cellspacing="1" border="0" width="100%" class="border" align=center>
        <tr>
     ...
     <td><table class="border" border="0" cellspacing="1" width="100%" cellpadding="0">
          <tr class="title" height="22"> 
            ...
            <td width="151" align="center"><strong>留言会员名</strong></td>
            <td width="151" align="center"><strong>留言内容</strong></td>
            <td width="151" align="center"  height="22"><strong>留言时间</strong></td>
            <td width="161" align="center" ><strong>操作</strong></td>
            <!--<td width="40" align="center" ><strong>已审核</strong></td>-->
          </tr>
       
			<%	
   	sql="SELECT * FROM  "&jieducm&"_tribebook  order by id desc"
	...
	if PageNo=1 then i=rs.RECORDCOUNT else i=rs.RECORDCOUNT-(30*(PageNo-1))
	 DO WHILE NOT rs.EOF AND RowCount>0%>
		  <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#cccccc'" style="padding: 0px 2px;">
			...
			<% Sql1 = "select  tribename  from "&jieducm&"_tribe where id="&rs("tribeid")&" "
            Set Rs1 = Server.CreateObject("Adodb.RecordSet")
				Rs1.Open Sql1,conn,1,1
				if NOT rs1.EOF  then
				tribename=rs1("tribename")
            end if
			response.Write(tribename)
		    rs1.close
			  %></td>
            <td width="151" align="center"><%=rs("username")%></td>
            <td width="151" align="center"><%=rs("content")%></td>
            <td width="151" align="center"><%=rs("now")%></td>
            <td width="161" align="center">&nbsp; <a href="tribe_bookdel.asp?id=<%=rs("id")%>" onClick="return confirm('确定要删除选中的记录吗？本操作将把无法恢复！');">删除</a></td>
          </tr>
            <%
      rs.MoveNext
	  RowCount = RowCount - 1 
