 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = '/templates/images/js/images/'; //图片路径配置
...
Dialog.prototype.setPosition = function () {
    ...
    thisdialogDiv.style.background = "none repeat scroll 0 0 #DDDDDD";
    thisdialogDiv.style.padding = "3px";
...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table id="_DialogTable_' + this.ID + '" class="win" width="' + (this.Width ) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;border:0px solid #4E86C4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td style="background:url(' + IMAGESPATH + 'bg_popup_h2.png) repeat-x scroll 0 0 transparent;" class="h2bg"><div style="padding: 5px 0 5px 10px; float: left; font-weight: bold; color:#333;"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <a onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" class="popup_close" href="#"></a></td>\
    </tr>\
    <tr valign="top">\
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
        ...
        if (isIE6) {
            //alert(bgdiv.getElementsByTagName("IFRAME")[0]);
            var bgIframeDoc = bgdiv.getElementsByTagName("IFRAME")[0].contentWindow.document;
            bgIframeDoc.open();
            //bgIframeDoc.write("<head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /></head>");
            bgIframeDoc.write("<body style='background-color:red' oncontextmenu='return false;'></body>");
            bgIframeDoc.close();
			bgIframeDoc=null;
        }
    }
